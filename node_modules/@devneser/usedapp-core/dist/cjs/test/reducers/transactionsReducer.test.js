...
describe('transactionsReducer', function () {
    it('addTransaction', function () {
        var _a;
        var transaction = {
            transaction: { chainId: src_1.ChainId.Fuji },
            submittedAt: 10
        };
        chai_1.expect(reducer_1.transactionReducer({}, { type: 'ADD_TRANSACTION', payload: transaction })).to.deep.eq((_a = {},
            _a[src_1.ChainId.Fuji] = [transaction],
            _a));
    });
